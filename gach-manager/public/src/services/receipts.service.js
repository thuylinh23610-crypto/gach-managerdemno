window.GM_receipts = (function(){
  ...
  try { await window.GM_realtime?.pushAll(true); } catch(e) { console.error('[receipts] pushAll failed:', e); }
    return rec;
  }
